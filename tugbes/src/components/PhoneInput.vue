<template>
    <div class="h-[93px] flex flex-col justify-start items-start gap-2.5">
      <label
        :for="id"
      ...
      >
        ...
        <input
          ...
          class="grow h-full pl-2 pr-4 text-[#3c4959] text-sm font-normal font-['General Sans'] leading-snug tracking-tight outline-none"
        />
      </div>
